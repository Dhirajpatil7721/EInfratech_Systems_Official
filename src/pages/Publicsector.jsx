    ...
    <>
      <div>
        ...
        <div className="page-title"
          style={{ backgroundImage: `url('https://images.unsplash.com/photo-1614850523011-8f49ffc73908?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')`, backgroundSize: 'cover', height: '40vh' }}>
          ...
          <div className="row align-items-center ">
            ...
            <div className="col-md-6 text-center">
              <img
                ...
                style={{ height: "50vh" ,margintop: "80px"}}
              // style={{height: '55%'}}
              />
            </div>
            ...
            <div className="col-md-6 px-5">
              <div className="service-section " data-aos="fade-up">
                ...
                <p style={{    paddingright: "2rem !important",paddingleft: "2rem !important"}}>
                Unify enterprise service management into a single platform to enhance efficiency, collaboration, and automation. Streamline operations, boost productivity, and improve customer and employee experiences by integrating all service aspects for seamless, cohesive, and optimized business processes.
                </p>
                <ul>
                  <li>
          ...
          <div className="row align-items-center mb-5 ">
            ...
            <div className="col-md-6">
              ...
              <div className="service-section  px-5 mt-3" data-aos="fade-up">
                ...
                <p style={{    paddingright: "2rem !important",paddingleft: "2rem !important"}}>
                Unify all aspects of enterprise service management into a single, streamlined platform, enhancing efficiency, collaboration, and automation for seamless operations, improved productivity, and better customer and the employee experiences.Bring together all aspects of enterprise service for seamless the operations.automation for seamless  operations, improved productivity,  better customer.
                </p>
                <ul>
                  <li>
        ...
        <section className="container-fluid bg-primary text-white py-5 mt-4">
          <div className="row align-items-center">
            {/* Image Section */}
